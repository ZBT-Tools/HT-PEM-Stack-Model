...
incompressible_polynomials = \
    {
        'Density':
            {
                'H2O':
                    np.array((1.351e+03, -2.422e00, 6.312e-03, -6.989e-06))
            },
        'Specific Heat':
            {
                'H2O':
                    np.array((6.515e+01, -6.166e-01, 2.299e-03, -3.755e-06,
                              2.276e-09))
            },
        'Viscosity':
            {
                'H2O':
                    np.array((3.738e-02, -3.093e-04, 9.609e-07, -1.320e-09,
                              6.746e-13))
            },
        'Thermal Conductivity':
            {
                'H2O':
                    np.array((-2.946e-01, 4.757e-03, -5.712e-06))
            }
    }
