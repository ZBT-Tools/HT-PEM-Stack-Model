...
class Manifold:
    ...
    def __init__(self, dict_manifold, cells, channels,
        ...
        self.head_p = np.full((2, self.n_channels), dict_manifold['p_out'])
        self.head_stoi = 1.5
        self.cells = cells
        ...
        try:
            self.id_hc = half_cell_names.index(half_cell_name)
        except ValueError:
    ...
    def calc_new_cell_flows(self):
        ...
        self.cell_mol_flow[0] = (self.head_p[0] - self.head_p[1]) \
                                * self.ref_perm * self.channel_cross_area[0] / (np.average(self.cell_visc)
    ...
    def calc_new_cell_stoi(self):
        ...
        """
        self.cell_stoi = self.cell_mol_flow[0] * self.n_channels * self.head_stoi \
