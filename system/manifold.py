...
class Manifold:
    ...
    def __init__(self, dict_manifold_const):
        ...
        self.extent = 2. * (self.head_height + self.head_width)
        self.hydraulic_diameter = 4. * self.cross_area / self.extent
    ...
    def calc_header_mass_flows(self):
        ...
        for q in range(2):
            self.head_mass_flow[q] = np.matmul(self.fwd_mat,
                                               self.cell_mass_flow[q])
    ...
    def calc_header_heat_capacity(self):
        ...
        self.head_cp[1] = np.matmul(self.fwd_mat, self.cell_mass_flow[1]
    ...
    def calc_header_gas_constant(self):
        ...
        self.head_r[1] = np.matmul(self.fwd_mat,
                                   self.cell_mass_flow[1] * self.cell_R_avg[1])\
            / self.head_mass_flow[1]
